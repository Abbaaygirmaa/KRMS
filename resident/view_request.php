                                ...
                                <div class="nk-block nk-block-lg">
                                    <div class="nk-block-head">
                                        <div class="nk-block-head-content">
                                            <h4 class="nk-block-title">View Id Card request </h4>
                                                ...
                                                <div class="datatable-wrap my-3">
                                                    <table
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <?php
                                                            $sql = mysqli_query($conn, "SELECT CONCAT(resident.firstName)as fullname,request_id_card.id as tID, resident.residentUsername as username, resident.id as id,resident.userPhoto as userphoto, `resident_username`, `title`, `description`, request_id_card.status as stat, request_id_card.date,`message` FROM `request_id_card` INNER JOIN resident on resident_username =resident.residentUsername WHERE resident_username = '$username' ORDER BY `request_id_card`.`id` ASC");
                                                ...
                                                <div class="datatable-wrap my-3">
                                                    <table
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <?php
                                                            $sql = mysqli_query($conn, "SELECT CONCAT(resident.firstName)as fullname,transform_list.id as tID, resident.residentUsername as username,resident.userPhoto as userphoto, `resident_username`, `title`, `description`, `transformKebel`, transform_list.status as stat, transform_list.date,transform_list.status as tranStatus FROM `transform_list` INNER JOIN resident on resident_username =resident.residentUsername WHERE resident_username = '$username' ");
                                                            while ($row = mysqli_fetch_assoc($sql)) {
