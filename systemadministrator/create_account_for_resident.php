...
if (isset($_POST['submit'])) {
    ...
    if (mysqli_num_rows($select_username) > 0) {
        ...
        // execute if no error
        $sql = mysqli_query($conn, "INSERT INTO `user`(`custom_id`,`fullName`, `phoneNumber`, `age`, `nationality`, `woreda`, `kebele`, `role`, `jobLocation`, `userPhoto`, `username`, `password`) VALUES ('KMSR/','$fullName','$phoneNumber','$age','$nationality','$woreda','$kebele','$role','$jobLocation','$fileNew','$username','$password')");
        if ($sql) {
                                ...
                                <div class="nk-block">
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <form action="./systemadministrator/create_account_for_resident.php"
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="fullName" name="fullName"
                                                                ...
                                                                pattern=".([A-zÀ-ž\s]){5,40}" title="6 to 30 characters"
                                                                required>
                                                        </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="form-group col-md-6">
                                                                ...
                                                                <input type="number" id="age" name="age"
                                                                    ...
                                                                    maxlength="3"
                                                                    value="<?php echo isset($_POST['age']) ? $age : ''; ?>"
                                                                    pattern=".{1,3}" title="1-3 digit  numbers"
                                                                    required>
                                                            </div>
                                                            <div class="form-group col-md-6">
                                                                ...
                                                                <input type="text" id="nationality" name="nationality"
                                                                    class="form-control" placeholder="Ethiopia"
                                                                    value="<?php echo isset($_POST['nationality']) ? $nationality : ''; ?>"
                                                                    required>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="col-md-6">
                                                            ...
                                                            <div class="form-control-wrap ">
                                                                <div class="form-control-select">
                                                                    <select name="role" class="form-control"
                                                                        id="jobTitle-06">
                                                                        <option value="resident" required>
                                                                            Resident</option>
                                                        ...
                                                        <div class="form-group">
                                                            <label class="form-label" for="jobTitle">Resident
                                                                Location</label>
                                                            <div class="form-control-wrap ">
                                                                <div class="form-control-select">
                                                ...
                                                <button name="submit" type="submit"
                                                    class="btn btn-primary btn-inline mt-4">Submit</button>
