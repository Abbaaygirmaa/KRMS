                                                ...
                                                <div class="datatable-wrap my-3">
                                                    <table
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <?php
                                                            $sql = mysqli_query($conn, "SELECT CONCAT(`custom_id`,`id`) as `customId`,`id`, `custom_id`, `fullName`, `phoneNumber`, `age`, `nationality`, `woreda`, `kebele`, `role`, `jobLocation`, `userPhoto`, `username`, `password`, `date`, `status` FROM `user` WHERE `role` = 'resident'");
