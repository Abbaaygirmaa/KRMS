                                ...
                                <div class="nk-block nk-block-lg">
                                    <div class="nk-block-head">
                                        <div class="nk-block-head-content">
                                            <h4 class="nk-block-title">Data List For Resident ID Card </h4>
                                                ...
                                                <div class="datatable-wrap my-3">
                                                    <table
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <?php
                                                            $sql = mysqli_query($conn, "SELECT CONCAT(id_card.custom_id,id_card.id) as customID,resident.id, id_card.custom_id, `issue_date`,`expired_date`,`id_image`,`residentUsername`, `firstName`, `nationality`, `woreda`, `region`, `kebele`, `birthDate`, `gender`, `houseNumber`, `phoneNumber`, `motherFullName`, `fatherFullName`, `emergencyFamilyName`, `emergencyFamilyNumber`, `city`, id_card.status as idStatus FROM `resident` INNER JOIN id_card ON `user_id` =resident.id");
                                                                                    ...
                                                                                    <ul class="link-list-opt no-bdr">
                                                                                        ...
                                                                                        <li><a
                                                                                                href="chairman/give_id_card.php?id=<?php echo $row['id'] ?>"><em
                                                                                                    class="icon ni ni-property"></em><span>Update
                                                                                                    Id Card</span></a>
                                                                                        </li>
                                                                                        <li><a
                                                                                                href="chairman/print_id_card.php?id=<?php echo $row['id'] ?>"><em
                                                                                                    class="icon ni ni-property"></em><span>Print
                                                                                                    Id Card</span></a>
                                                                                        </li>
