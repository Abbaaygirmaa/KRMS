                                                                            ...
                                                                            <div class="drodown">
                                                                                ...
                                                                                <div
                                                                                    ...
                                                                                    <ul class="link-list-opt no-bdr">
                                                                                        ...
                                                                                        <li><a
                                                                                                href="chairman/approve_request.php?id=<?php echo $row['resident_username'] ?>"><em
                                                                                                    class="icon ni ni-property"></em><span>Approve
                                                                                                    Request</span></a>
                                                                                        </li>
