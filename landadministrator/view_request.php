...
//login confirmation
confirm_logged_in();
$job_location = $_SESSION['jobLocation'];
?>
                                ...
                                <div class="nk-block nk-block-lg">
                                    <div class="nk-block-head">
                                        <div class="nk-block-head-content">
                                            <h4 class="nk-block-title">Request List For Resident </h4>
                                                ...
                                                <div class="datatable-wrap my-3">
                                                    <table
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <?php
                                                            $sql = mysqli_query($conn, "SELECT CONCAT(resident.firstName)as fullname,transform_list.id as tID, resident.residentUsername as username,resident.userPhoto as userphoto, `resident_username`, `title`, `description`, `transformKebel`, transform_list.status as stat, transform_list.date,transform_list.status as tranStatus, transform_list.transformKebel FROM `transform_list` INNER JOIN resident on resident_username =resident.residentUsername WHERE transform_list.status = 'pending' AND transform_list.transformKebel = '$job_location'");
                                                                            ...
                                                                            <div class="drodown">
                                                                                ...
                                                                                <div
                                                                                    ...
                                                                                    <ul class="link-list-opt no-bdr">
                                                                                        <li><a
                                                                                                href="recordofficer/view_transfer_details.php?username=<?php echo $row['username'] ?>"><em
                                                                                                    class="icon ni ni-eye"></em><span>View
                                                                                                    Details</span></a>
                                                                                        </li>
                                                                                        <li><a
                                                                                                href="chairman/transfer_resident?id=<?php echo $row['tID'] ?>"><em
                                                                                                    class="icon ni ni-account-setting-alt"></em><span>Transfer
                                                                                                    Resident</span></a>
                                                                                        </li>
