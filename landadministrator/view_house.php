...
if (isset($_GET['status'])) {
    ...
    if ($_GET['status'] == 'active') {
        mysqli_query($conn, "UPDATE `house` SET `status`= 'active' WHERE `id`= '$id'");
        // $alert = true;
        // $alertMsg1 = "resident Active !!";
        // $alertStatus = "alert-success";
        // $alertMsg2 = " account status has been updated accordingly. ";
        header("location:view_house.php");
    } else if ($_GET['status'] == 'disable') {
        mysqli_query($conn, "UPDATE `house` SET `status`= 'disable' WHERE `id`= '$id'");
        $_SESSION['delmsg'] = "house Suspend !!";
        header("location:view_house.php");
    }
}
                                ...
                                <div class="nk-block nk-block-lg">
                                    <div class="nk-block-head">
                                        <div class="nk-block-head-content">
                                            <h4 class="nk-block-title">Data List For House</h4>
                                                ...
                                                <div class="datatable-wrap my-3">
                                                    <table
                                                        ...
                                                        <thead>
                                                            <tr class="nk-tb-item nk-tb-head" role="row">
                                                                ...
                                                                <th class="nk-tb-col tb-col-mb sorting" tabindex="0"
                                                                    aria-controls="DataTables_Table_1" rowspan="1"
                                                                    colspan="1"
                                                                    aria-label="house type: activate to sort column ascending">
                                                                    <span class="sub-text">house type</span>
                                                                </th>
                                                                <th class="nk-tb-col tb-col-md sorting" tabindex="0"
                                                                    aria-controls="DataTables_Table_1" rowspan="1"
                                                                    colspan="1"
                                                                    aria-label="house number: activate to sort column ascending">
                                                                    <span class="sub-text">house number</span>
                                                                </th>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <?php
                                                            $sql = mysqli_query($conn, "SELECT CONCAT(`custom_id`,`id`) AS customID ,`id`, `custom_id`, `recordOfficerId`, `username`, `houseType`, `houseNumber`, `woreda`, `kebele`, `numberOfFamily`, `housePart`, `kareMeter`, `status`, `registerDate` FROM `house` WHERE `recordOfficerId` = '$recordOfficerId'");
                                                            while ($row = mysqli_fetch_assoc($sql)) {
                                                                ...
                                                                $numberOfFamily = $row['numberOfFamily'];

                                                                $housePart = $row['housePart'];

                                                                $kareMeter = $row['kareMeter'];
                                                            ...
                                                            <tr class="nk-tb-item even">
                                                                ...
                                                                <td class="nk-tb-col tb-col-mb" data-order="35040.34">
                                                                    <span
                                                                        class="tb-role"><?php echo htmlspecialchars($houseType) ?></span>
                                                                </td>
                                                                <td class="nk-tb-col tb-col-md">
                                                                    <span><?php echo htmlspecialchars($houseNumber) ?></span>
                                                                </td>
                                                                <td class="nk-tb-col tb-col-lg">
                                                                    <span><?php echo htmlspecialchars($woreda) ?></span>
                                                                </td>
                                                                <td class="nk-tb-col tb-col-lg">
                                                                ...
                                                                <td class="nk-tb-col nk-tb-col-tools">
                                                                    <ul class="nk-tb-actions gx-1">
                                                                        ...
                                                                        <li class="nk-tb-action-hidden">
                                                                            <a href="recordOfficer/view_house.php?id=<?php echo $row['id'] ?>&status=disable"
                                                                        ...
                                                                        <?php
                                                                            ...
                                                                            ?>
                                                                        <li class="nk-tb-action-hidden">
                                                                            <a href="recordOfficer/view_house.php?id=<?php echo $row['id'] ?>&status=active"
                                                                                class="btn btn-trigger btn-icon"
                                                                                data-toggle="tooltip"
                                                                                data-placement="top" title=""
                                                                            ...
                                                                            <div class="drodown">
                                                                                ...
                                                                                <div
                                                                                    ...
                                                                                    <ul class="link-list-opt no-bdr">
                                                                                        ...
                                                                                        <li><a
                                                                                                href="recordOfficer/view_house_details.php?id=<?php echo $row['id'] ?>"><em
                                                                                                    class="icon ni ni-eye"></em><span>View
                                                                                                    Details</span></a>
                                                                                        </li>
                                                                                        <!-- <li><a href="systemadministrator/edit_account_employee.php?id=<?php echo $row['id'] ?>"><em class="icon ni ni-account-setting-alt"></em><span>Edit
                                                                                                        User</span></a>
                                                                                            </li> -->
