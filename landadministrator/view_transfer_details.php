...
if (isset($_GET['tid'])) {
    $tid = $_GET['tid'];
    $update_status = mysqli_query($conn, "UPDATE `transform_list` SET `status`='accepted' WHERE id = '$tid'");

    $transfer_resident = mysqli_query($conn, "UPDATE `resident` set `recordOfficerId`='$recordOfficerId' WHERE `residentUsername` = '$username'");
?>
<script>
alert('Resident Transfer')
</script>
<?php
}
?>
                                                        ...
                                                        <div class="col-lg-7">
                                                            ...
                                                            <div class="card card-bordered">
                                                                <ul class="data-list is-compact">
                                                                    <li class="data-item">
                                                                        <div class="data-col">
                                                                            <div class="data-label">የአመልች ሙሉ ስመ</div>
                                                                            <div class="data-value">
                                                                    ...
                                                                    <li class="data-item">
                                                                        <a href="recordofficer/view_transfer_details.php?username=<?php echo $username ?>&tid=<?php echo $tid ?>"
                                                                            class="btn btn-primary"
                                                                            onClick="return confirm('Are you sure Accept request?')">
                                                                            Accept
                                                                            Request</a>
                                                                    </li>
